 ...
 * In webtrees website it is used for link to the BVfF.
 ...
 * Kopiert von MainMenuManual 
 * Copyright (c) 2023 Hans-Joachim Lünenschloß
 *
...
namespace JpNamespace\Webtrees\Module\MainMenuBVfF;
...
class MainMenuBVfF extends AbstractModule implements ModuleCustomInterface, ModuleMenuInterface, ModuleGlobalInterface
{
    use ModuleCustomTrait;
    use ModuleMenuTrait;
    use ModuleGlobalTrait;
    
    public const CUSTOM_MODULE = 'jp-main-menu-bvff';
    public const CUSTOM_AUTHOR = 'Hans-Joachim Lünenschloß';
    public const CUSTOM_WEBSITE = 'https://github.com/luenissla/' . self::CUSTOM_MODULE . '/';
    ...
    {
        return I18N::translate('Main menu bvff');
    }
    ...
    public function description(): string
    {
        ...
        return I18N::translate('Add an extra item to the main menu as a link to the BVfF.');
    }
    ...
    public function getMenu(Tree $tree): ?Menu
    {
        ...
        $menu_title = I18N::translate('zum BVfF');

        return new Menu($menu_title, e($url), 'jp-main-menu-bvff');
    }
    ...
    {
        $url = $this->assetUrl('css/main-menu-bvff.css');
